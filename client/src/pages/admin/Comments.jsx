...
import { comments_data } from "../../QuickBlog-Assets/assets"
import CommentsTableItems from "../../components/admin/CommentsTableItems"
      ...
      <div className="relative h-4/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-lg scrollbar-hide">
        <table className="w-full text-sm text-gray-500">
          ...
          <tbody>
            ...
            }).map((comment, index) => <CommentsTableItems key={comment._id} comment={comment} index={index + 1} fetchComments={fetchComments} />)}
